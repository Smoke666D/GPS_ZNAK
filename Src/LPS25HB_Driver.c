...
static HAL_StatusTypeDef LPS25HB_ReadReg(uint16_t RegAddr, uint16_t NumByteToRead, uint8_t *Data) {
  HAL_StatusTypeDef s;
  RegAddr = RegAddr | 0x80;
  s =  HAL_I2C_Mem_Read(&hi2c1, LPS25HB_ADDRESS, RegAddr, 1, Data, NumByteToRead, 1000);
  return s;
}

static HAL_StatusTypeDef LPS25HB_WriteReg(uint16_t RegAddr, uint16_t NumByteToWrite, uint8_t *Data) {
  HAL_StatusTypeDef s;
  RegAddr = RegAddr | 0x80;
  s =  HAL_I2C_Mem_Write(&hi2c1, LPS25HB_ADDRESS, RegAddr, 1, Data, NumByteToWrite, 1000);
  return s;
}
